...
from app.models.doctor import Doctor, TimePeriod, Appointment
...
async def update_doctor_data(doctor_id: str, received_doctor_data: dict) -> JSONResponse:
    is_successful = await update_doctor(doctor_id, received_doctor_data)
