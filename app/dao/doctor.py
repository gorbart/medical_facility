...
from app.models.doctor import Appointment, AppointmentInCreate, Doctor, DoctorSpecialtyLink, Specialty, SpecialtyEnum, TimePeriod, TimePeriodInCreate, TimePeriodInResponse, WorkingHours, WorkingHoursInCreate
